...
shouldIgnore)` function in the middleware, passing a `true` value if the rule has no matches and should not apply the poisoning, and therefore continuing with the next middleware stack.
